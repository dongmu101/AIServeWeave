...
更新日期：2026-09-07。M1–M3 已完成；M4 完成只读的 C21/C23，M5 完成 C25 与 C26（C27–C29 未做，理由见各节）。本文记录 `service/aiServeWeaveConsole` 的现状、实施顺序、后端依赖与验收标准；任务尚未实现时保持未勾选，不将依赖安装视为业务功能完成。
