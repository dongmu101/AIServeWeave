...
// Rerank scores documents against a query. Ollama's Discover never reports
// CapabilityRerank today, so the shared gate in Base rejects every call as
// unsupported (STATUS.md's P2).
