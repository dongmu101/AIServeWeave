...
| [ ] | P10 | 稳定性与界面验收 | **已启动，保留未完成**。长稳工具新增有界采样、CSV/JSON 摘要、防覆盖、失败清理与连续性检查；2m/race 冒烟及同版逐副本替换五次通过。Console Q03 已补 Chromium 75 项验收，并修复页面/卡片长文本溢出、短屏对话框、缺失标签和当前导航标记。2026-09-12 已冻结测试二进制启动 24h 合成后端长稳，须等待完整结果后归档；**真实流量熔断校准未完成**，当前默认值不变。同版替换不代表跨版本兼容，版本与发版安排由维护者处理。操作步骤见 [P10 验收手册](deploy/p10-acceptance.md)，实测与覆盖边界见 [验收记录](docs/acceptance/p10-2026-09-12/README.md)。 |
